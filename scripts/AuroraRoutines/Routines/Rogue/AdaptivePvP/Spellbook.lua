...
local EnemyAbilities = {
    ...
    PRIEST = {
        ...
        Heal = { id = 2054, castTime = 3, heal = true },
        Renew = { id = 139, cooldown = 0, duration = 15, hot = true },
        Prayer_of_Healing = { id = 596, castTime = 3, aoe = true, heal = true },
        Mind_Blast = { id = 8092, cooldown = 8, castTime = 1.5, damage = true },
        Shadow_Word_Pain = { id = 589, cooldown = 0, dot = true },
        Holy_Fire = { id = 14914, cooldown = 10, castTime = 3.5, damage = true, dot = true },
        Smite = { id = 585, castTime = 2.5, damage = true },
        Mana_Burn = { id = 8129, cooldown = 0, castTime = 3, manaDrain = true },
        Dispel_Magic = { id = 527, cooldown = 0, dispel = true },
        Cure_Disease = { id = 528, cooldown = 0, dispel = true },
        Abolish_Disease = { id = 552, cooldown = 0, dispel = true },
        Inner_Fire = { id = 588, cooldown = 0, duration = 600, buff = true },
        Power_Word_Fortitude = { id = 1243, cooldown = 0, duration = 1800, buff = true },
        Fear_Ward = { id = 6346, cooldown = 30, duration = 180, fearImmunity = true },
        Mind_Soothe = { id = 453, cooldown = 0, range = 20, pacify = true },
        Shackle_Undead = { id = 9484, cooldown = 0, duration = 8, incapacitate = true },
        Mind_Vision = { id = 2096, cooldown = 0, duration = 60, vision = true },
        Resurrection = { id = 2006, castTime = 10, resurrect = true },
        Spirit_of_Redemption = { id = 20711, passive = true, deathEffect = true },
        Desperate_Prayer = { id = 19236, cooldown = 600, instantHeal = true },
        Elunes_Grace = { id = 2651, cooldown = 300, duration = 15, rangedDodge = true },
        Starshards = { id = 10797, cooldown = 0, dot = true },
        Touch_of_Weakness = { id = 2652, cooldown = 0, debuff = true }
    },
    WARLOCK = {
